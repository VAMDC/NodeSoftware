...
class Transition(models.Model):
    ...
    loggf = models.DecimalField(max_digits=5, decimal_places=3,null=True,blank=True)
    landeff = models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True)
    gammarad = models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True)
    gammastark = models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True) 
    gammawaals = models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True) 
