...
class TestTagMakers(TestGen):
    ...
    def test_makeShellType(self):
        ...
        self.assertEqual(generators.makeShellType("testtag","Test", G),
                         '<testtag shellid"=TestNode-TestID"><PrincipalQuantumNumber>3</PrincipalQuantumNumber><OrbitalAngularMomentum><Value>2</Value></OrbitalAngularMomentum><NumberOfElectrons>2</NumberOfElectrons><Parity>2</Parity><Kappa>0.1</Kappa><TotalAngularMomentum>2</TotalAngularMomentum><ShellTerm></ShellTerm></Test>')
    def test_makeNormalMode(self):
        ...
        self.assertEqual(generators.makeNormalMode(G),
                         '<NormalMode methodRef="MTestNode-TestMethod" electronicStateRef="STestNode-2" id="VTestNode-42" pointGroupSymmetry="1"><Comments>TestComment</Comments><SourceRef>BTestNode-ref1</SourceRef><SourceRef>BTestNode-ref2</SourceRef><HarmonicFrequency methodRef="MTestNode-ex"><Comments>Comment</Comments><SourceRef>BTestNode-ref1</SourceRef><SourceRef>BTestNode-ref2</SourceRef><Value units="K">42</Value><Accuracy confidenceInterval="1" type="1" relative="true">1</Accuracy><Accuracy confidenceInterval="2" type="2">2</Accuracy><Evaluation methodRef="ex" recommended="true"><SourceRef>BTestNode-ref1</SourceRef><SourceRef>BTestNode-ref2</SourceRef><Comments>Comment</Comments><Quality>1</Quality></Evaluation><Evaluation methodRef="ex" recommended="true"><SourceRef>BTestNode-ref1</SourceRef><SourceRef>BTestNode-ref2</SourceRef><Comments>Comment</Comments><Quality>2</Quality></Evaluation></HarmonicFrequency><Intensity methodRef="MTestNode-ex"><Comments>Comment</Comments><SourceRef>BTestNode-ref1</SourceRef><SourceRef>BTestNode-ref2</SourceRef><Value units="K">42</Value><Accuracy confidenceInterval="1" type="1" relative="true">1</Accuracy><Accuracy confidenceInterval="2" type="2">2</Accuracy><Evaluation methodRef="ex" recommended="true"><SourceRef>BTestNode-ref1</SourceRef><SourceRef>BTestNode-ref2</SourceRef><Comments>Comment</Comments><Quality>1</Quality></Evaluation><Evaluation methodRef="ex" recommended="true"><SourceRef>BTestNode-ref1</SourceRef><SourceRef>BTestNode-ref2</SourceRef><Comments>Comment</Comments><Quality>2</Quality></Evaluation></Intensity><DisplacementVectors methodRef="MTestNode-TestMethod" units="K"><Comments>TestComment</Comments><SourceRef>BTestNode-ref1</SourceRef><SourceRef>BTestNode-ref2</SourceRef><Vector ref="ref1" x3="1" y3="1" z3="1"></Vector><Vector x3="2" y3="2" z3="2"></Vector><Vector x3="3" y3="3" z3="3"></Vector></DisplacementVectors></NormalMode>')
