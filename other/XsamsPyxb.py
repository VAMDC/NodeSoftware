...
# Generated 2010-09-07 13:27:56.899793 by PyXB version 1.1.2-DEV
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:f63681ca-ba72-11df-843d-0026189cb7c8')
...
class STD_ANON_1 (pyxb.binding.datatypes.IDREF):
...
STD_ANON_1._CF_pattern.addPattern(pattern=u'M.+')
...
STD_ANON_2._CF_pattern.addPattern(pattern=u'B.+')
...
STD_ANON_3._CF_pattern.addPattern(pattern=u'B.+')
...
STD_ANON_5._CF_pattern.addPattern(pattern=u'S.+')
...
# Atomic SimpleTypeDefinition
class STD_ANON_6 (pyxb.binding.datatypes.ID):
...
# Atomic SimpleTypeDefinition
class STD_ANON_7 (pyxb.binding.datatypes.IDREF):
...
STD_ANON_8._CF_pattern.addPattern(pattern=u'M.+')
...
OrbitalAngularMomentumSymbolType._InitializeFacetMap(OrbitalAngularMomentumSymbolType._CF_pattern,
   OrbitalAngularMomentumSymbolType._CF_length)
...
class PrimaryType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __methodRef = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'methodRef'), 'methodRef', '__AbsentNamespace0_PrimaryType_methodRef', STD_ANON_1)
    ...
    __sourceRef = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'sourceRef'), 'sourceRef', '__AbsentNamespace0_PrimaryType_sourceRef', STD_ANON_2)
...
class SourceType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __sourceID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'sourceID'), 'sourceID', '__AbsentNamespace0_SourceType_sourceID', STD_ANON_3, required=True)
...
class ReferencedTextType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute sourceRef uses Python identifier sourceRef
    __sourceRef = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'sourceRef'), 'sourceRef', '__AbsentNamespace0_ReferencedTextType_sourceRef', STD_ANON_2)
...
class SolidType (PrimaryType):
    ...
    __stateID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'stateID'), 'stateID', '__AbsentNamespace0_SolidType_stateID', STD_ANON_5, required=True)
...
class FunctionType (PrimaryType):
    ...
    __functionID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'functionID'), 'functionID', '__AbsentNamespace0_FunctionType_functionID', STD_ANON_6, required=True)
...
class MethodType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __functionRef = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'functionRef'), 'functionRef', '__AbsentNamespace0_MethodType_functionRef', STD_ANON_7)
    ...
    __methodID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'methodID'), 'methodID', '__AbsentNamespace0_MethodType_methodID', STD_ANON_8, required=True)
    
    methodID = property(__methodID.value, __methodID.set, None, u'ID for a specific method')

    
    # Attribute sourceRef uses Python identifier sourceRef
    __sourceRef = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'sourceRef'), 'sourceRef', '__AbsentNamespace0_MethodType_sourceRef', STD_ANON_2)
...
class ParticleType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute stateID uses Python identifier stateID
    __stateID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'stateID'), 'stateID', '__AbsentNamespace0_ParticleType_stateID', STD_ANON_5, required=True)
...
class MolecularStateType (PrimaryType):
    ...
    # Attribute stateID uses Python identifier stateID
    __stateID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'stateID'), 'stateID', '__AbsentNamespace0_MolecularStateType_stateID', STD_ANON_5)
...
class AtomicStateType (PrimaryType):
    ...
    # Attribute stateID uses Python identifier stateID
    __stateID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'stateID'), 'stateID', '__AbsentNamespace0_AtomicStateType_stateID', STD_ANON_5, required=True)
...
ParticlePropertiesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ParticlePropertiesType._UseForTag(pyxb.namespace.ExpandedName(None, u'ParticlePolarization'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParticlePropertiesType._UseForTag(pyxb.namespace.ExpandedName(None, u'ParticleMass'))),
    ])
...
DataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DataType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DataType._UseForTag(pyxb.namespace.ExpandedName(None, u'Value'))),
    ])
...
MolecularChemicalSpeciesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'CNPIGroup'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'CASRegistryNumber'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'MoleculeNuclearSpins'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'InChI'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'IonCharge'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'StableMolecularProperties'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'ChemicalName'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'IUPACName'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=MolecularChemicalSpeciesType._UseForTag(pyxb.namespace.ExpandedName(None, u'URLFigure'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
    ])
...
StateEnergyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=StateEnergyType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=StateEnergyType._UseForTag(pyxb.namespace.ExpandedName(None, u'Value'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=StateEnergyType._UseForTag(pyxb.namespace.ExpandedName(None, u'Value'))),
    ])
...
RadiativeTransitionProbabilityType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=RadiativeTransitionProbabilityType._UseForTag(pyxb.namespace.ExpandedName(None, u'IdealisedIntensity'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RadiativeTransitionProbabilityType._UseForTag(pyxb.namespace.ExpandedName(None, u'TransitionProbabilityA'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=RadiativeTransitionProbabilityType._UseForTag(pyxb.namespace.ExpandedName(None, u'Multipole'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=RadiativeTransitionProbabilityType._UseForTag(pyxb.namespace.ExpandedName(None, u'WeightedOscillatorStrength'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RadiativeTransitionProbabilityType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
...
RotationalComponentType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=RotationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'MixingCoefficient'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RotationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'SerialQuantumNumber'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RotationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'SerialQuantumNumber'))),
    ])
...
VibrationalQuantumNumbersType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=VibrationalQuantumNumbersType._UseForTag(pyxb.namespace.ExpandedName(None, u'VibronicAngularMomentumK'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=VibrationalQuantumNumbersType._UseForTag(pyxb.namespace.ExpandedName(None, u'VibronicAngularMomentumP'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=VibrationalQuantumNumbersType._UseForTag(pyxb.namespace.ExpandedName(None, u'VibronicAngularMomentumP'))),
    ])
...
MoleculeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=MoleculeType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=MoleculeType._UseForTag(pyxb.namespace.ExpandedName(None, u'MolecularChemicalSpecies'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=MoleculeType._UseForTag(pyxb.namespace.ExpandedName(None, u'MolecularChemicalSpecies'))),
    ])
...
VibrationalComponentType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'SerialQuantumNumber'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'Description'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'RotationalHome'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'MixingCoefficient'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'VibrationalCharacterisation'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'VibrationalQuantumNumbers'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'RotationalHome'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=VibrationalComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
...
RoVibronicSplittingType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RoVibronicSplittingType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RoVibronicSplittingType._UseForTag(pyxb.namespace.ExpandedName(None, u'Label'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RoVibronicSplittingType._UseForTag(pyxb.namespace.ExpandedName(None, u'Label'))),
    ])
...
WavelengthWavenumberType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=WavelengthWavenumberType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=WavelengthWavenumberType._UseForTag(pyxb.namespace.ExpandedName(None, u'Ritz'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=WavelengthWavenumberType._UseForTag(pyxb.namespace.ExpandedName(None, u'Theoretical'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=WavelengthWavenumberType._UseForTag(pyxb.namespace.ExpandedName(None, u'Experimental'))),
...
TermType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TermType._UseForTag(pyxb.namespace.ExpandedName(None, u'jK'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TermType._UseForTag(pyxb.namespace.ExpandedName(None, u'LK'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TermType._UseForTag(pyxb.namespace.ExpandedName(None, u'LS'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TermType._UseForTag(pyxb.namespace.ExpandedName(None, u'jj'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=TermType._UseForTag(pyxb.namespace.ExpandedName(None, u'J1J2'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=TermType._UseForTag(pyxb.namespace.ExpandedName(None, u'TermLabel'))),
    ])
...
AtomicNumericalDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=AtomicNumericalDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'QuantumDefect'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AtomicNumericalDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'IonizationEnergy'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=AtomicNumericalDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'LandeFactor'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AtomicNumericalDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'StatisticalWeight'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=AtomicNumericalDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalLifeTime'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=AtomicNumericalDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AtomicNumericalDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'Polarizability'))),
...
CollisionalProcessClassType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CollisionalProcessClassType._UseForTag(pyxb.namespace.ExpandedName(None, u'UserDefinition'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CollisionalProcessClassType._UseForTag(pyxb.namespace.ExpandedName(None, u'IAEACode'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CollisionalProcessClassType._UseForTag(pyxb.namespace.ExpandedName(None, u'Code'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
NonRadiativeTransitionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=NonRadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'InitialStateRef'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=NonRadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=NonRadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Probability'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=NonRadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'FinalStateRef'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=NonRadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Type'))),
    ])
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=NonRadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Type'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=NonRadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'NonRadiativeWidth'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=NonRadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'TransitionEnergy'))),
    ])
...
MolecularStateCharacterisation_oldType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=MolecularStateCharacterisation_oldType._UseForTag(pyxb.namespace.ExpandedName(None, u'Parameters'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=MolecularStateCharacterisation_oldType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalStatisticalWeight'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=MolecularStateCharacterisation_oldType._UseForTag(pyxb.namespace.ExpandedName(None, u'NuclearStatisticalWeight'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MolecularStateCharacterisation_oldType._UseForTag(pyxb.namespace.ExpandedName(None, u'PseudoStatisticalWeight'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=MolecularStateCharacterisation_oldType._UseForTag(pyxb.namespace.ExpandedName(None, u'PseudoNuclearStatisticalWeight'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=MolecularStateCharacterisation_oldType._UseForTag(pyxb.namespace.ExpandedName(None, u'LifeTime'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MolecularStateCharacterisation_oldType._UseForTag(pyxb.namespace.ExpandedName(None, u'PseudoStatisticalWeight'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=MolecularStateCharacterisation_oldType._UseForTag(pyxb.namespace.ExpandedName(None, u'NuclearStatisticalWeight'))),
...
ElectronicCharacterisationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ElectronicCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'TermSymbol'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ElectronicCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'SymmetryGroup'))),
...
IsotopeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=IsotopeType._UseForTag(pyxb.namespace.ExpandedName(None, u'IsotopeParameters'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IsotopeType._UseForTag(pyxb.namespace.ExpandedName(None, u'IonState'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IsotopeType._UseForTag(pyxb.namespace.ExpandedName(None, u'IonState'))),
    ])
...
IonStateType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=IonStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'IsoelectronicSequence'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=IonStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'AtomicState'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=IonStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'AtomicState'))),
    ])
...
RotationalCharacterisationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RotationalCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'PermutationSymmetry'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RotationalCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'RovibronicAngularMomentumP'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=RotationalCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'InversionSymmetry'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RotationalCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'PermutationSymmetry'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=RotationalCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'InversionSymmetry'))),
...
TabulatedDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TabulatedDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'ReferenceFrame'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=TabulatedDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'ProductionDate'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TabulatedDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'DataXY'))),
    ])
...
HyperfineCouplingBType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=HyperfineCouplingBType._UseForTag(pyxb.namespace.ExpandedName(None, u'HyperfineQuantumNumbers'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=HyperfineCouplingBType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalAngularMomentumJ'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
    ])
...
NonLinearElecCouplingType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=NonLinearElecCouplingType._UseForTag(pyxb.namespace.ExpandedName(None, u'EfSymmetry'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=NonLinearElecCouplingType._UseForTag(pyxb.namespace.ExpandedName(None, u'Label'))),
...
NonLinearElecNoHyperFType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=NonLinearElecNoHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalAngularMomentumN'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=NonLinearElecNoHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'EfSymmetry'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=NonLinearElecNoHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalAngularMomentumN'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=NonLinearElecNoHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'EfSymmetry'))),
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=NonLinearElecNoHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalMagneticQuantumNumberJ'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
    ...
    , 7 : pyxb.binding.content.ContentModelState(state=7, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=NonLinearElecNoHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalMagneticQuantumNumberJ'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=NonLinearElecNoHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'RoVibronicSplitting'))),
    ])
    , 8 : pyxb.binding.content.ContentModelState(state=8, is_final=True, transitions=[
    ])
})
...
FunctionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Expression'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Expression'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Description'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'SourceCodeURL'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
    ...
    , 9 : pyxb.binding.content.ContentModelState(state=9, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Parameters'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'ReferenceFrame'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Description'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=FunctionType._UseForTag(pyxb.namespace.ExpandedName(None, u'SourceCodeURL'))),
    ])
    , 10 : pyxb.binding.content.ContentModelState(state=10, is_final=True, transitions=[
...
CollisionalTransitionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CollisionalTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'IntermediateStates'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=CollisionalTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Products'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=CollisionalTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Threshold'))),
    ])
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=CollisionalTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Products'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=CollisionalTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Threshold'))),
...
EnergyWavelengthType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=EnergyWavelengthType._UseForTag(pyxb.namespace.ExpandedName(None, u'Wavenumber'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=EnergyWavelengthType._UseForTag(pyxb.namespace.ExpandedName(None, u'Wavelength'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=EnergyWavelengthType._UseForTag(pyxb.namespace.ExpandedName(None, u'Energy'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=EnergyWavelengthType._UseForTag(pyxb.namespace.ExpandedName(None, u'Frequency'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=EnergyWavelengthType._UseForTag(pyxb.namespace.ExpandedName(None, u'Wavelength'))),
...
NonLinearElecHyperFType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=NonLinearElecHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'EfSymmetry'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=NonLinearElecHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalAngularMomentumN'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=NonLinearElecHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'Label'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=NonLinearElecHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalAngularMomentumN'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=NonLinearElecHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'HyperfineQuantumNumbers'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
    ...
    , 7 : pyxb.binding.content.ContentModelState(state=7, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=NonLinearElecHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'HyperfineQuantumNumbers'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=NonLinearElecHyperFType._UseForTag(pyxb.namespace.ExpandedName(None, u'RoVibronicSplitting'))),
    ])
    , 8 : pyxb.binding.content.ContentModelState(state=8, is_final=True, transitions=[
    ])
})
...
RadiativeTransitionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'EnergyWavelength'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=RadiativeTransitionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
...
FitDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'FunctionRef'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'PhysicalUncertainty'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'ProductionDate'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'FunctionRef'))),
    ])
    ...
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'PhysicalUncertainty'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'ProductionDate'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'FitAccuracy'))),
    ])
    , 7 : pyxb.binding.content.ContentModelState(state=7, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=FitDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'ProductionDate'))),
    ])
...
MolecularStateCharacterisationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=MolecularStateCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'NuclearStatisticalWeight'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=MolecularStateCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'StateEnergy'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=MolecularStateCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalStatisticalWeight'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=MolecularStateCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'NuclearSpinSymmetry'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MolecularStateCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'LifeTime'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MolecularStateCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'Parameters'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MolecularStateCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'LifeTime'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MolecularStateCharacterisationType._UseForTag(pyxb.namespace.ExpandedName(None, u'Parameters'))),
...
ElectronicComponentType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'VibrationalHome'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'MixingCoefficient'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'ElectronicCharacterisation'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalMolecularProjectionL'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'Description'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'SerialQuantumNumber'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalMolecularProjectionL'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ElectronicComponentType._UseForTag(pyxb.namespace.ExpandedName(None, u'VibrationalHome'))),
...
IsotopeParametersType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=IsotopeParametersType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IsotopeParametersType._UseForTag(pyxb.namespace.ExpandedName(None, u'MassNumber'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IsotopeParametersType._UseForTag(pyxb.namespace.ExpandedName(None, u'MassNumber'))),
    ])
...
LinearElecCouplingType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=LinearElecCouplingType._UseForTag(pyxb.namespace.ExpandedName(None, u'HyperfineCaseABeta'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=LinearElecCouplingType._UseForTag(pyxb.namespace.ExpandedName(None, u'EfSymmetry'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LinearElecCouplingType._UseForTag(pyxb.namespace.ExpandedName(None, u'HundCaseA'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=LinearElecCouplingType._UseForTag(pyxb.namespace.ExpandedName(None, u'HyperfineCaseAAlpha'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=LinearElecCouplingType._UseForTag(pyxb.namespace.ExpandedName(None, u'HundCaseB'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=LinearElecCouplingType._UseForTag(pyxb.namespace.ExpandedName(None, u'HyperfineCouplingHundCaseB'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
...
MolecularStateType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=MolecularStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=MolecularStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'MolecularStateCharacterisation'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=MolecularStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalSpinMomentumS'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=MolecularStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalMagneticQuantumNumberS'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=MolecularStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'Parity'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=MolecularStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'ElectronicHome'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=MolecularStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'Parity'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=MolecularStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
...
AsymmetricProjectionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AsymmetricProjectionType._UseForTag(pyxb.namespace.ExpandedName(None, u'AsymmetricTau'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AsymmetricProjectionType._UseForTag(pyxb.namespace.ExpandedName(None, u'AsymmetricKa'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AsymmetricProjectionType._UseForTag(pyxb.namespace.ExpandedName(None, u'AsymmetricKa'))),
    ])
...
AtomicStateType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AtomicStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'AtomicComposition'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AtomicStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'AtomicQuantumNumbers'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AtomicStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'AtomicNumericalData'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AtomicStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comments'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=AtomicStateType._UseForTag(pyxb.namespace.ExpandedName(None, u'Description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
AtomicCoreType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AtomicCoreType._UseForTag(pyxb.namespace.ExpandedName(None, u'ElementCore'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AtomicCoreType._UseForTag(pyxb.namespace.ExpandedName(None, u'Configuration'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AtomicCoreType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalAngularMomentum'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AtomicCoreType._UseForTag(pyxb.namespace.ExpandedName(None, u'Term'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AtomicCoreType._UseForTag(pyxb.namespace.ExpandedName(None, u'Configuration'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AtomicCoreType._UseForTag(pyxb.namespace.ExpandedName(None, u'TotalAngularMomentum'))),
...
RotationalHomeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RotationalHomeType._UseForTag(pyxb.namespace.ExpandedName(None, u'Description'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RotationalHomeType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=RotationalHomeType._UseForTag(pyxb.namespace.ExpandedName(None, u'RotationalCharacterisation'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RotationalHomeType._UseForTag(pyxb.namespace.ExpandedName(None, u'Comment'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=RotationalHomeType._UseForTag(pyxb.namespace.ExpandedName(None, u'RotationalCharacterisation'))),
