...
DATABASE_NAME = '/home/tom/py/vamdc/DjVAMDC/vald3.db'             # Or path to database file if using sqlite3.
...
ADMIN_MEDIA_PREFIX = 'http://vamdc.fysast.uu.se:8888/admin-media/'
