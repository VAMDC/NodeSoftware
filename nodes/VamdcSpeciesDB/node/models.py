...
class VamdcSpecies(models.Model):
  ...
  inchikey_duplicate_counter = models.IntegerField(default=1)#!!!WTF, why was it unique?unique=True)
  ...
  species_type = models.ForeignKey(VamdcSpeciesTypes, null=True, on_delete=models.DO_NOTHING)
  ...
  origin_member_database = models.ForeignKey(VamdcNodes, db_column='member_databases_id', on_delete=models.DO_NOTHING)
...
class VamdcSpeciesNames(models.Model):
    ...
    species = models.ForeignKey(VamdcSpecies, on_delete=models.DO_NOTHING)
    name = models.CharField(max_length=450)
    markup_type = models.ForeignKey(VamdcMarkupTypes, on_delete=models.DO_NOTHING)
...
class VamdcNodesTopics(models.Model):
    id = models.AutoField(primary_key=True)
    node = models.ForeignKey(VamdcNodes, on_delete=models.DO_NOTHING)
    topic = models.ForeignKey(VamdcTopics, on_delete=models.DO_NOTHING)
