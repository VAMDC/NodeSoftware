...
class Transitions(models.Model):
    ...
    chiantiradtransfinalstateindex = models.ForeignKey(States, related_name='finalstateindex')
    chiantiradtransinitialstateindex = models.ForeignKey(States, related_name='initialstateindex')
