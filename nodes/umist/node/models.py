...
# Source doesn't have a formal PK in UMIST, but we can allocate one here, since 'abbr' is unique.
class Source(models.Model):
    abbr = models.CharField(primary_key=True, max_length=12, blank=True)
...
class NewInchi(models.Model):
    inchikey = models.CharField(max_length=90, primary_key=True)
    inchi = models.CharField(max_length=12000)
    class Meta:
        db_table = u'new_inchi'
