    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lostate', models.ForeignKey(db_column='lostate', db_index=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='islowerstate_trans', to='node_molec.state')),
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='node_common.species')),
                ('upstate', models.ForeignKey(db_column='upstate', db_index=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='isupperstate_trans', to='node_molec.state')),
            ],
            options={
