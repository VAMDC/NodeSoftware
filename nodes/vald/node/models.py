...
class Reference(Model):
    dbref = CharField(max_length=64, primary_key=True)
...
class State(Model):
    ...
    species = ForeignKey(Species, db_column='species', db_index=True)#, validators=[myvalidate])    
    #species = PositiveSmallIntegerField()    
    ...
    energy_ref = ManyToManyField(Reference, through='LineList',related_name='isenergyref_state')
    lande_ref = ManyToManyField(Reference, through='LineList',related_name='islanderef_state')
    level_ref = ManyToManyField(Reference, through='LineList',related_name='islevelref_state')
...
class Transition(Model):
    ...
    wave_ref = ManyToManyField(Reference, through='LineList',related_name='iswaveref_trans')
    loggf_ref = ManyToManyField(Reference, through='LineList',related_name='isloggfref_trans')
    lande_ref = ManyToManyField(Reference, through='LineList',related_name='islanderef_trans')
    gammarad_ref = ManyToManyField(Reference, through='LineList',related_name='isgammaradref_trans')
    gammastark_ref = ManyToManyField(Reference, through='LineList',related_name='isgammastarkref_trans')
    waals_ref = ManyToManyField(Reference, through='LineList',related_name='iswaalsref_trans')
...
class LineList(Model):
    ...
    transition = ForeignKey(Transition)
