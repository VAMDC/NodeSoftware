...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'species', 'nuclear_charge', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=3, null=True))

    def backwards(self, orm):

        # Changing field 'Species.nuclear_charge'
        db.alter_column(u'species', 'nuclear_charge', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None, max_length=3))
