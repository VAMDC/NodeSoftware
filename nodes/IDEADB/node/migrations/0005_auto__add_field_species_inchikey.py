...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.inchikey'
        db.add_column(u'species', 'inchikey',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=27, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.inchikey'
        db.delete_column(u'species', 'inchikey')
