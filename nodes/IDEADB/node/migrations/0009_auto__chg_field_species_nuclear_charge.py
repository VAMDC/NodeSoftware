...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Species.nuclear_charge'
        db.alter_column(u'species', 'nuclear_charge', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Species.nuclear_charge'
        db.alter_column(u'species', 'nuclear_charge', self.gf('django.db.models.fields.SmallIntegerField')(max_length=3))
    ...
    models = {
        ...
        'node.species': {
            ...
            'nuclear_charge': ('django.db.models.fields.PositiveSmallIntegerField', [], {'max_length': '3', 'blank': 'True'})
        }
    }
