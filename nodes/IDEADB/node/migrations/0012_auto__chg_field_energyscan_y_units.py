...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Energyscan.y_units'
        db.alter_column('node_energyscan', 'y_units', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Energyscan.y_units'
        db.alter_column('node_energyscan', 'y_units', self.gf('django.db.models.fields.TextField')())
