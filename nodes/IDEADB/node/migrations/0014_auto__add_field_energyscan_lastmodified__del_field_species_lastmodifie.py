...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Energyscan.lastmodified'
        db.add_column('node_energyscan', 'lastmodified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 3, 0, 0), auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)

        # Deleting field 'Species.lastmodified'
        db.delete_column(u'species', 'lastmodified')


    def backwards(self, orm):
        # Deleting field 'Energyscan.lastmodified'
        db.delete_column('node_energyscan', 'lastmodified')

        # Adding field 'Species.lastmodified'
        db.add_column(u'species', 'lastmodified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 3, 0, 0), auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'node.energyscan': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 3, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
