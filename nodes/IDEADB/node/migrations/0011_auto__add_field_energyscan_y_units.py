...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Energyscan.y_units'
        db.add_column('node_energyscan', 'y_units',
                      self.gf('django.db.models.fields.TextField')(default='1/s'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Energyscan.y_units'
        db.delete_column('node_energyscan', 'y_units')
    ...
    models = {
        ...
        'node.energyscan': {
            ...
            'y_units': ('django.db.models.fields.TextField', [], {'default': "'1/s'"})
        },
        'node.experiment': {
