...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.middlename'
        db.add_column('node_author', 'middlename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


        # Changing field 'Author.lastname'
        db.alter_column('node_author', 'lastname', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Author.firstname'
        db.alter_column('node_author', 'firstname', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Deleting field 'Author.middlename'
        db.delete_column('node_author', 'middlename')
    ...
    models = {
        ...
        'node.energyscan': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
