...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Species.inchi'
        db.alter_column(u'species', 'inchi', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Species.inchi'
        db.alter_column(u'species', 'inchi', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        'node.species': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inchi': ('django.db.models.fields.CharField', [], {'max_length': '300', 'db_index': 'True'}),
