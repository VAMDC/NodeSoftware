...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.isotope'
        db.add_column(u'species', 'isotope',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.isotope'
        db.delete_column(u'species', 'isotope')
    ...
    models = {
        ...
        'node.species': {
            ...
            'nuclear_charge': ('django.db.models.fields.SmallIntegerField', [], {'max_length': '3', 'blank': 'True'})
        }
    }
